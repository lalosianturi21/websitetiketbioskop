...
<body>
    ...
    <div class="nav-wrapper">
        <div class="container">
            <div class="nav">
                <a href="#" class="logo">
                <i class="fa-solid fa-film bx-tada main-color text-warning"></i><span class="main-color text-warning"> S</span>word <span class="main-color text-warning">F</span>lix
                </a>
    ...
    <div class="hero-section" id="movie">
        ...
        <div class="hero-slide">
            <div class="owl-carousel carousel-nav-center" id="hero-carousel">
                ...
                <a href="login.php" onclick="login()"><img src="./images/black-banner.png" alt=""></a>
                ...
                <!-- SLIDE ITEM -->
                <div class="hero-slide-item">
                <a href="login.php"><img src="./images/supergirl-banner.jpg" alt=""></a>
                    <div class="overlay"></div>
                    <div class="hero-slide-item-content">
                        <div class="item-content-wraper">
                            <div class="item-content-title top-down">
                ...
                <!-- SLIDE ITEM -->
                <div class="hero-slide-item">
                <a href="login.php"><img src="./images/wanda-banner.jpg" alt=""></a>
                    <div class="overlay"></div>
                    <div class="hero-slide-item-content">
                        <div class="item-content-wraper">
                            <div class="item-content-title top-down">
        ...
        <div class="top-movies-slide" id="genre">
            <div class="owl-carousel" id="top-movies-slide">
                ...
                <a href="login.php" onclick="login()"><img src="./images/series/supergirl.jpg" alt=""></a>
                ...
                <!-- MOVIE ITEM -->
                <div class="movie-item">
                <a href="login.php" onclick="login()"><img src="./images/movies/captain-marvel.png" alt=""></a>
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Captain Marvel
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <div class="movie-item">
                <a href="login.php" onclick="login()"><img src="./images/cartoons/demon-slayer.jpg" alt=""></a>
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Infinity Train
                        </div>
                ...
                <div class="movie-item">
                <a href="login.php" onclick="login()"><img src="./images/movies/blood-shot.jpg" alt=""></a>
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Bloodshot
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <div class="movie-item">
                <a href="login.php" onclick="login()"><img src="./images/series/wanda.jpg" alt=""></a>
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Wanda Vision
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <div class="movie-item">
                <a href="login.php" onclick="login()"><img src="./images/movies/bat-man.jpg" alt=""></a>
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            The Dark Knight
                        </div>
    ...
    <div class="section" id="genre">
        ...
        <div class="container">
            ...
            <div class="movies-slide carousel-nav-center owl-carousel">
                <!-- MOVIE ITEM -->
                <a href="login.php" onclick="login()" class="movie-item">
    ...
    <section class="about-section">
    	<div class="container" >
        	<div class="row clearfix" >
                ...
                <!--Content Column-->
                <a href="#" class="logo text-center" id="about">
